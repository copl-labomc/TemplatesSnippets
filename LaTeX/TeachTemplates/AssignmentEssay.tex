%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%AssignmentEssay.tex : Modèle de document pour un énoncé de travail à remettre dans un cours du Département de physique, de génie physique et d'optique - FSG - Université Laval.
%------------------------------------------------------------------
...
\vspace{0.3em}
\centering
\textbf{N'oubliez pas de citer vos références.}\par %% dans le cas de problèmes à développement, rajouter "et d'expliciter votre démarche".
\vspace{-0.3em}
