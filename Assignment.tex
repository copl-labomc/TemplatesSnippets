%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Assignment.tex : Modèle de document pour un énoncé de travail à remettre dans un cours du Département de physique, de génie physique et d'optique - FSG - Université Laval.
%------------------------------------------------------------------
...
%
%---------------------------------------------------------
%Begin homemade header (inspiré de l'équipe du Prof. L.J. Dubé)
%
\begin{center}
    \textbf{\large{Titre du cours}}\\
    \vspace{0.2em}
    \textbf{PHY/GPH-Numéro du cours}
