...
\documentclass[english,french,12pt,letterpaper]{}
...
%\usepackage{pythontex} %%Python code executable in LaTeX!
...
\usepackage{fancyhdr}
\usepackage{setspace} %%interline spacing tools ; units relative to current font: ex - height of an 'x', em - width of an 'M' (uppercase)
