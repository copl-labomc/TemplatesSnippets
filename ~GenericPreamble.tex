...
\PassOptionsToPackage{mathscr}{eucal}\usepackage{amsfonts,eucal,mathrsfs,textcomp} %%math fonts and more symbols, extensively listed in the 'latex-AllSymbolList.pdf' of this repository
...
\usepackage[usenames,x11names,table]{xcolor} %%colour names in 'xcolor-palettes.pdf' of this repository. For printing, the [cmyk,dvipsnames] colour model is preferred.
...
\hypersetup{   %%for hyperref package
    ...
    citecolor=blue,
    filecolor=blue}
%\pgfplotsset{compat=1.9,width=5cm,color=blue} %%"compat" argument advised for the pgfplots package
